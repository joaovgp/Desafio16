...
class DBHandler():
  ...
  def select_data(self, tags: list, init_t: str, final_t: str) -> dict[list, list]:
    """
    Método para coleta de dados no BD entre 2 horários especificados
    @input: tags: lista de tags a serem buscados
    @input: init_t: horário inicial da busca
    @input: final_t: horário final da busca
    @output: result: lista de dicionários com os dados buscados
    """
    cols = list(tags)
